...
// Servo adjustment
#define _DUTY_MAX 2180  // Servo angle: D degree
#define _DUTY_NEU 1940 // Servo angle: 0 degree
#define _DUTY_MIN 1700   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1392 + -8.07 * a_value + 0.0163 * (a_value) * (a_value) + -1.11E-05 * (a_value) * (a_value) *(a_value);
}
